...
// Verify this file exists in components/ui/badge.tsx
...
export default async function DoctorAvailability() {
  ...
  return (
    <Card className="shadow-sm border-0 h-full">
      <CardHeader>
        <CardTitle className="text-base font-semibold">Doctor Status</CardTitle>
      </CardHeader>
          ...
          return (
            <div key={doc.id} className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                {/* Updated to bg-linear-to-br for Tailwind v4 compatibility */}
